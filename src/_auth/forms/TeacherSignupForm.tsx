...
import { TeacherSignupValidation } from "@/lib/validation";
import { z } from "zod";
...
const TeacherSignupForm = () => {
  ...
  const form = useForm<z.infer<typeof TeacherSignupValidation>>({
    resolver: zodResolver(TeacherSignupValidation),
    defaultValues: {
      firstName: "",
      lastName: "",
      email: "",
  ...
  async function onSubmit(values: z.infer<typeof TeacherSignupValidation>) {
    try {
